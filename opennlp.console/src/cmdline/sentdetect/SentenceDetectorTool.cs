...
namespace opennlp.console.cmdline.sentdetect
{
    ...
    public sealed class SentenceDetectorTool : BasicCmdLineTool
    {
        ...
        {
            get { return "learnable sentence detector"; }
        }

        public override string Help
        {
            get { return "Usage: " + CLI.CMD + " " + Name + " model < sentences"; }
        }
        ...
        public override void run(string[] args)
        {
            ...
            else
            {
                ...
                ObjectStream<string> paraStream =
                    new ParagraphStream(new PlainTextByLineStream(new InputStreamReader(GetInputStream(args))));
