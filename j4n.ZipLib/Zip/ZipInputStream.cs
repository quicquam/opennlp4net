...
using System;
using System.IO;
using j4n.Zip.Checksums;
using j4n.Zip.Encryption;
using j4n.Zip.Zip.Compression;
using j4n.Zip.Zip.Compression.Streams;

namespace j4n.Zip.Zip
{
	/// <summary>
	...
	public class ZipInputStream : InflaterInputStream
	{
		...
		public ZipEntry GetNextEntry()
		{
			...
			if (header == ZipConstants.CentralHeaderSignature ||
                ...
                // MJJ 2014/11/20 Removed close so it can support nested zips
                //Close();
                return null;
			}
