...
// ReSharper disable once InconsistentNaming
	public class QNModel : AbstractModel
	{
	  ...
	  // FROM trainer
	  public QNModel(LogLikelihoodFunction monitor, double[] parameters) : base(null, monitor.PredLabels, monitor.OutcomeLabels)
	  {
	  ...
	  // FROM model reader
	  public QNModel(string[] predNames, string[] outcomeNames, Context[] @params, double[] parameters) : base(@params, predNames, outcomeNames)
	  {
		 this.prior = new UniformPrior();
		 this.modelType = ModelTypeEnum.MaxentQn;
