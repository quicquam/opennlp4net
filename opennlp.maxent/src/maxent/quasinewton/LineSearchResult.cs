...
namespace opennlp.maxent.quasinewton
{
    ...
    public class LineSearchResult
    {
        ...
        public LineSearchResult(double stepSize, double valueAtX, double valurAtX_1, double[] gradAtX,
            double[] gradAtX_1, double[] currPoint, double[] nextPoint, int fctEvalCount)
        {
        ...
        {
            get { return valueAtCurr; }
            set { this.valueAtCurr = value; }
        }

        public virtual double ValueAtNext
        {
            get { return valueAtNext; }
            set { this.valueAtNext = value; }
        }

        public virtual double[] GradAtCurr
        {
            get { return gradAtCurr; }
            set { this.gradAtCurr = value; }
        }

        public virtual double[] GradAtNext
        {
            get { return gradAtNext; }
            set { this.gradAtNext = value; }
        }

        public virtual double[] CurrPoint
        {
            get { return currPoint; }
            set { this.currPoint = value; }
        }

        public virtual double[] NextPoint
        {
            get { return nextPoint; }
            set { this.nextPoint = value; }
        }

        public virtual int FctEvalCount
        {
            get { return fctEvalCount; }
            set { this.fctEvalCount = value; }
        }
    }
}