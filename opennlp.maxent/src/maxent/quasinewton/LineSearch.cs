...
namespace opennlp.maxent.quasinewton
{
	...
	public class LineSearch
	{
	  ...
	  public static LineSearchResult doLineSearch(DifferentiableFunction function, double[] direction, LineSearchResult lsr, bool verbose)
	  {
	  ...
	  private static bool checkArmijoCond(double valueAtX, double valueAtNewPoint, double[] gradAtX, double[] direction, double currStepSize, bool isMaximizing)
	  {
		// check Armijo rule;
	  ...
	  private static bool checkCurvature(double[] gradAtNewPoint, double[] gradAtX, double[] direction, int domainDimension, bool isMaximizing)
	  {
