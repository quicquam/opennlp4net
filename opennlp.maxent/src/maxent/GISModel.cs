...
namespace opennlp.maxent
{
	...
	public sealed class GISModel : AbstractModel
	{
	  ...
	  public GISModel(Context[] @params, string[] predLabels, string[] outcomeNames, int correctionConstant, double correctionParam) : this(@params, predLabels, outcomeNames, correctionConstant, correctionParam, new UniformPrior())
	  {
	  }
	  ...
	  public GISModel(Context[] @params, string[] predLabels, string[] outcomeNames, int correctionConstant, double correctionParam, Prior prior) : base(@params, predLabels, outcomeNames, correctionConstant, correctionParam)
	  {
		this.prior = prior;
...
//ORIGINAL LINE: public static void main(String[] args) throws java.io.IOException
	  public static void Main(string[] args)
	  {
        ...
        BufferedReader @in = new BufferedReader(new InputStreamReader(new InputStream(Console.OpenStandardInput()))); // TODO get from System.in
