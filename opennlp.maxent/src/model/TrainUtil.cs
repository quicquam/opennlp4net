...
namespace opennlp.model
{
    ...
    public class TrainUtil
    {
        ...
        private static bool getBooleanParam(IDictionary<string, string> trainParams, string key, bool defaultValue,
            IDictionary<string, string> reportMap)
        {
            string valueString = trainParams[key];
        ...
        public static bool isValid(IDictionary<string, string> trainParams)
        {
            ...
            if (algorithmName != null &&
                !(MAXENT_VALUE.Equals(algorithmName) || MAXENT_QN_VALUE.Equals(algorithmName) ||
                  PERCEPTRON_VALUE.Equals(algorithmName) || PERCEPTRON_SEQUENCE_VALUE.Equals(algorithmName)))
            {
                return false;
            }
