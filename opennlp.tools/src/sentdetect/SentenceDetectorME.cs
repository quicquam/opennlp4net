...
namespace opennlp.tools.sentdetect
{
    ...
    public class SentenceDetectorME : SentenceDetector
    {
        ...
        {
            SentenceDetectorFactory sdFactory = new SentenceDetectorFactory(languageCode, useTokenEnd, abbreviations,
                null);
            ...
            SentenceDetectorFactory sdFactory, TrainingParameters mlParams)
        {
            ...
            EventStream eventStream = new SDEventStream(samples, sdFactory.SDContextGenerator,
