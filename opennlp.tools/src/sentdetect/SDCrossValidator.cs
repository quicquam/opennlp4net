...
namespace opennlp.tools.sentdetect
{
	...
	public class SDCrossValidator
	{
	  ...
	  public SDCrossValidator(string languageCode, TrainingParameters @params, SentenceDetectorFactory sdFactory, params SentenceDetectorEvaluationMonitor[] listeners)
	  {
	  ...
	  public SDCrossValidator(string languageCode, int cutoff, int iterations) : this(languageCode, ModelUtil.createTrainingParameters(cutoff, iterations))
	  {
	  }
	  ...
	  ///             <seealso cref="#SDCrossValidator(String, TrainingParameters, SentenceDetectorFactory, SentenceDetectorEvaluationMonitor...)"/>
	  ///             and pass in a <seealso cref="SentenceDetectorFactory"/>. 
	  public SDCrossValidator(string languageCode, TrainingParameters @params) : this(languageCode, @params, new SentenceDetectorFactory(languageCode, true, null, null))
	  {
	  }
	  ...
	  [Obsolete("use <seealso cref=\"#SDCrossValidator(String, opennlp.tools.util.TrainingParameters, opennlp.tools.dictionary.Dictionary, SentenceDetectorEvaluationMonitor...)\"/>")]
	  public SDCrossValidator(string languageCode, int cutoff, int iterations, Dictionary abbreviations) : this(languageCode, ModelUtil.createTrainingParameters(cutoff, iterations), new SentenceDetectorFactory(languageCode, true, abbreviations, null))
	  {
	  }
	  ...
	  ///             instead and pass in a TrainingParameters object. 
	  public SDCrossValidator(string languageCode, TrainingParameters @params, params SentenceDetectorEvaluationMonitor[] listeners) : this(languageCode, @params, new SentenceDetectorFactory(languageCode, true, null, null), listeners)
	  {
	  }
