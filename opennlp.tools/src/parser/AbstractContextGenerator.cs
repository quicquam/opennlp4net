...
namespace opennlp.tools.parser
{
    ...
    public abstract class AbstractContextGenerator
    {
        ...
        protected internal virtual void cons2(IList<string> features, Cons c0, Cons c1, ICollection<Parse> punct1s,
            bool bigram)
        {
            if (punct1s != null)
            {
        ...
        protected internal virtual void cons3(IList<string> features, Cons c0, Cons c1, Cons c2,
            ICollection<Parse> punct1s, ICollection<Parse> punct2s, bool trigram, bool bigram1, bool bigram2)
        {
        ...
        protected internal virtual void surround(Parse node, int i, string type, ICollection<Parse> punctuation,
