...
namespace opennlp.tools.parser.chunking
{
    ...
    public class Parser : AbstractBottomUpParser
    {
        ...
        public Parser(ParserModel model, int beamSize, double advancePercentage)
            : this(
                model.BuildModel, model.CheckModel, new POSTaggerME(model.ParserTaggerModel, 10, 0),
        ...
        [Obsolete]
        public Parser(MaxentModel buildModel, MaxentModel checkModel, POSTagger tagger, Chunker chunker,
            HeadRules headRules)
