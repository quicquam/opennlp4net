...
namespace opennlp.tools.postag
{
    ...
    public class POSSample
    {
        ...
        public POSSample(string[] sentence, string[] tags, string[][] additionalContext)
            : this(sentence.ToList(), tags.ToList(), additionalContext)
        {
        }
        ...
        private void checkArguments()
        {
            ...
            {
                throw new System.ArgumentException("There must be exactly one tag for each token. tokens: " +
                                                   sentence.Count + ", tags: " + tags.Count);
            }
        ...
        {
            get { return this.additionalContext; }
        }
