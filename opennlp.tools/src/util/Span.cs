...
namespace opennlp.tools.util
{
    ...
    public class Span : IComparable<Span>
    {
        ...
        public Span(int s, int e, string type)
        {
            ...
            if (s > e)
            {
                throw new System.ArgumentException("start index must not be larger than end index: " + "start=" + s +
                                                   ", end=" + e);
            }
        ...
        public virtual bool intersects(Span s)
        {
            ...
            return this.contains(s) || s.contains(this) || Start <= sstart && sstart < End ||
                   sstart <= Start && Start < s.End;
        }
        ...
        public virtual bool crosses(Span s)
        {
            ...
            return !this.contains(s) && !s.contains(this) &&
                   (Start <= sstart && sstart < End || sstart <= Start && Start < s.End);
        }
        ...
        public virtual CharSequence getCoveredText(CharSequence text)
        {
            if (End > text.length())
            {
                throw new System.ArgumentException("The span " + ToString() +
        ...
        public override bool Equals(object o)
        {
            ...
            else if (o is Span)
            {
                ...
                result = (Start == s.Start) && (End == s.End) && (Type != null ? type.Equals(s.Type) : true) &&
                         (s.Type != null ? s.Type.Equals(Type) : true);
            }
            else
            {
                result = false;
