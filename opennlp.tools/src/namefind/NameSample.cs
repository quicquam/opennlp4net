...
namespace opennlp.tools.namefind
{
    ...
    public class NameSample
    {
        ...
        {
            get { return isClearAdaptiveData; }
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            else if (obj is NameSample)
            {
                ...
                return Arrays.Equals(Sentence, a.Sentence) && Arrays.Equals(Names, a.Names) &&
                       Arrays.Equals(AdditionalContext, a.AdditionalContext) &&
                       ClearAdaptiveDataSet == a.ClearAdaptiveDataSet;
            }
            else
            {
                return false;
        ...
        public static NameSample parse(string taggedTokens, string defaultType, bool isClearAdaptiveData)
        {
            ...
            for (int pi = 0; pi < parts.Length; pi++)
            {
                ...
                if (startMatcher.matches())
                {
                    if (catchingName)
                    {
                        throw new IOException("Found unexpected annotation" + " while handling a name sequence: " +
