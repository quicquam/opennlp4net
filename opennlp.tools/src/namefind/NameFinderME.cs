...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not available in .NET:
            ...
            IDictionary<string, object> resources)
        {
            ...
            {
                featureGenerator = GeneratorFactory.create(new ByteArrayInputStream(generatorDescriptor),
                    new FeatureGeneratorResourceProviderAnonymousInnerClassHelper(resources));
            }
            else
            {
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not available in .NET:
        ...
        {
            return train(languageCode, type, samples, ModelUtil.createTrainingParameters(iterations, cutoff), generator,
                resources);
        }
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not available in .NET:
        ...
        public static TokenNameFinderModel train(string languageCode, string type, ObjectStream<NameSample> samples,
            sbyte[] generatorDescriptor, IDictionary<string, object> resources, int iterations, int cutoff)
        {
            ...
            TokenNameFinderModel model = train(languageCode, type, samples, featureGenerator, resources, iterations,
                cutoff);
