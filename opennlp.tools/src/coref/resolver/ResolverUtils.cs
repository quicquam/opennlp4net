...
namespace opennlp.tools.coref.resolver
{
	...
	public class ResolverUtils
	{
	  ...
	  public static readonly Pattern singularThirdPersonPronounPattern = Pattern.compile("^(he|she|it|him|her|his|hers|its|himself|herself|itself)$",Pattern.CASE_INSENSITIVE);
	  /// <summary>
	  /// Regular expression for English plural third person pronouns. </summary>
	  public static readonly Pattern pluralThirdPersonPronounPattern = Pattern.compile("^(they|their|theirs|them|themselves)$",Pattern.CASE_INSENSITIVE);
	  /// <summary>
	  /// Regular expression for English speech pronouns. </summary>
	  public static readonly Pattern speechPronounPattern = Pattern.compile("^(I|me|my|you|your|you|we|us|our|ours)$",Pattern.CASE_INSENSITIVE);
	  /// <summary>
	  /// Regular expression for English female pronouns. </summary>
	  public static readonly Pattern femalePronounPattern = Pattern.compile("^(she|her|hers|herself)$",Pattern.CASE_INSENSITIVE);
	  /// <summary>
	  /// Regular expression for English neuter pronouns. </summary>
	  public static readonly Pattern neuterPronounPattern = Pattern.compile("^(it|its|itself)$",Pattern.CASE_INSENSITIVE);
	  /// <summary>
	  /// Regular expression for English first person pronouns. </summary>
	  public static readonly Pattern firstPersonPronounPattern = Pattern.compile("^(I|me|my|we|our|us|ours)$",Pattern.CASE_INSENSITIVE);
	  /// <summary>
	  /// Regular expression for English singular second person pronouns. </summary>
	  public static readonly Pattern secondPersonPronounPattern = Pattern.compile("^(you|your|yours)$",Pattern.CASE_INSENSITIVE);
	  /// <summary>
	  /// Regular expression for English third person pronouns. </summary>
	  public static readonly Pattern thirdPersonPronounPattern = Pattern.compile("^(he|she|it|him|her|his|hers|its|himself|herself|itself|they|their|theirs|them|themselves)$",Pattern.CASE_INSENSITIVE);
	  /// <summary>
	  /// Regular expression for English singular pronouns. </summary>
	  public static readonly Pattern singularPronounPattern = Pattern.compile("^(I|me|my|he|she|it|him|her|his|hers|its|himself|herself|itself)$",Pattern.CASE_INSENSITIVE);
	  /// <summary>
	  /// Regular expression for English plural pronouns. </summary>
	  public static readonly Pattern pluralPronounPattern = Pattern.compile("^(we|us|our|ours|they|their|theirs|them|themselves)$",Pattern.CASE_INSENSITIVE);
	  /// <summary>
	  /// Regular expression for English male pronouns. </summary>
	  public static readonly Pattern malePronounPattern = Pattern.compile("^(he|him|his|himself)$",Pattern.CASE_INSENSITIVE);
	  /// <summary>
	  ...
	  public static readonly Pattern designatorsPattern = Pattern.compile("[a-z]\\.$|^[A-Z][b-df-hj-np-tv-xz]+$|^Co(rp)?$");
	  ...
	  public static MentionContext getProperNounExtent(DiscourseEntity de)
	  {
		for (IEnumerator<MentionContext> ei = de.Mentions; ei.MoveNext();) //use first extent which is propername
		{
		  ...
		  if (xecHeadTag.StartsWith("NNP", StringComparison.Ordinal) || initialCaps.matcher(xec.HeadTokenText).find())
		  {
			return xec;
		  }
		}
	  ...
	  public static IList<string> getPronounMatchFeatures(MentionContext mention, DiscourseEntity entity)
	  {
		...
		if (mention.HeadTokenTag.StartsWith("PRP", StringComparison.Ordinal))
		{
		  ...
		  for (IEnumerator<MentionContext> mi = entity.Mentions; mi.MoveNext();)
		  {
			...
			{
			  if (mention.HeadTokenText.Equals(candidateMention.HeadTokenText, StringComparison.CurrentCultureIgnoreCase))
			  {
			  ...
			  {
				IDictionary<string, string> candidatePronounMap = getPronounFeatureMap(candidateMention.HeadTokenText);
	  ...
	  public static IList<string> getCompatibilityFeatures(MentionContext mention, DiscourseEntity entity, TestSimilarityModel simModel)
	  {
