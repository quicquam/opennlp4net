    ...
    public class GenderModel : TestGenderModel, TrainSimilarityModel
    {
        ...
        public static void Main(string[] args)
        {
            ...
            for (string line = @in.readLine(); line != null; line = @in.readLine())
            {
                ...
                Console.WriteLine("m=" + dist[model.MaleIndex] + " f=" + dist[model.FemaleIndex] + " n=" +
                                  dist[model.NeuterIndex] + " " + model.getFeatures(Context.parseContext(words[0])));
            }
        }
        ...
        public virtual void trainModel()
        {
            ...
            (new SuffixSensitiveGISModelWriter(GIS.trainModel(new CollectionEventStream(events), true),
                new Jfile(modelName + modelExtension))).persist();
        }

        public virtual int FemaleIndex
        {
            get { return femaleIndex; }
        }

        public virtual int MaleIndex
        {
            get { return maleIndex; }
        }

        public virtual int NeuterIndex
        {
            get { return neuterIndex; }
        }
    }
}