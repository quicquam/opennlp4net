...
namespace opennlp.tools.coref.mention
{
    ...
    public abstract class AbstractMentionFinder : MentionFinder
    {
        ...
        {
            get { return collectPrenominalNamedEntities_Renamed; }
            set { collectPrenominalNamedEntities_Renamed = value; }
        }
		...
		*/
            ...
            for (int ti = npTokens.Count - 2; ti >= 0; ti--)
            {
                ...
                {
                    Mention ppExtent = new Mention(tok.Span, tok.Span, tok.EntityId, null,
                        opennlp.tools.coref.Linker_Fields.PRONOUN_MODIFIER);
        ...
        {
            get { return collectCoordinatedNounPhrases; }
            set { collectCoordinatedNounPhrases = value; }
        }
    }
}