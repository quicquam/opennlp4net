...
namespace opennlp.tools.coref.mention
{
    ...
    public class MentionContext : Context
    {
        ...
        public MentionContext(Span span, Span headSpan, int entityId, Parse parse, string extentType, string nameType,
            int mentionIndex, int mentionsInSentence, int mentionIndexInDocument, int sentenceIndex,
            HeadFinder headFinder) : base(span, headSpan, entityId, parse, extentType, nameType, headFinder)
        {
        ...
        public MentionContext(Mention mention, int mentionIndexInSentence, int mentionsInSentence,
            ...
            : this(
                mention.Span, mention.HeadSpan, mention.Id, mention.Parse, mention.type, mention.nameType,
                mentionIndexInSentence, mentionsInSentence, mentionIndexInDocument, sentenceIndex, headFinder)
        {
        }
	  ...
	  */
        ...
        {
            get { return this.nonDescriptorStart; }
        }
        ...
        {
            get { return maxNounLocation; }
        }

        public virtual Parse NextTokenBasal
        {
            get { return basalNextToken; }
        }
