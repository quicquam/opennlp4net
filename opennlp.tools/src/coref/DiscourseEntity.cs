...
namespace opennlp.tools.coref
{
    ...
    public class DiscourseEntity : DiscourseElement
    {
        ...
        public DiscourseEntity(MentionContext mention, GenderEnum gender, double genderProb, NumberEnum number,
            double numberProb) : base(mention)
        {
            this.gender = gender;
