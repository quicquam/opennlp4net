...
namespace opennlp.tools.tokenize
{
	...
	public class DetokenizationDictionary
	{
	  ...
	  public sealed class Operation
	  {
		...
		/// </summary>
		public static readonly Operation RIGHT_LEFT_MATCHING = new Operation("RIGHT_LEFT_MATCHING", InnerEnum.RIGHT_LEFT_MATCHING);
	  ...
	  private readonly IDictionary<string, DetokenizationDictionary.Operation> operationTable = new Dictionary<string, DetokenizationDictionary.Operation>();
	  /// <summary>
	  ...
	  public DetokenizationDictionary(string[] tokens, DetokenizationDictionary.Operation[] operations)
	  {
		...
		{
		  throw new System.ArgumentException("tokens and ops must have the same length: tokens=" + tokens.Length + ", operations=" + operations.Length + "!");
		}
