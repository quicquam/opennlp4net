...
namespace opennlp.tools.tokenize
{
    ...
    public class TokenizerME : AbstractTokenizer
    {
        ...
        [Obsolete("As of release 1.5.2, replaced by <seealso cref=\"Factory#getAlphanumeric(String)\"/>")] public static readonly Pattern alphaNumeric = Pattern.compile(Factory.DEFAULT_ALPHANUMERIC);
            ...
            TrainingParameters mlParams)
        {
            ...
            EventStream eventStream = new TokSpanEventStream(samples, factory.UseAlphaNumericOptmization,
            ...
            Dictionary abbreviations, bool useAlphaNumericOptimization, TrainingParameters mlParams)
        {
            ...
            EventStream eventStream = new TokSpanEventStream(samples, useAlphaNumericOptimization,
                factory.getAlphanumeric(languageCode),
                factory.createTokenContextGenerator(languageCode, getAbbreviations(abbreviations)));

            AbstractModel maxentModel = TrainUtil.train(eventStream, mlParams.getSettings(), manifestInfoEntries);

            return new TokenizerModel(languageCode, maxentModel, abbreviations, useAlphaNumericOptimization,
                manifestInfoEntries);
        }
        ...
        {
            return train(languageCode, samples, useAlphaNumericOptimization,
