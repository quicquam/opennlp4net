...
namespace opennlp.tools.tokenize
{
	...
	public sealed class TokenizerModel : BaseModel
	{
	  ...
	  public TokenizerModel(string language, AbstractModel tokenizerMaxentModel, Dictionary abbreviations, bool useAlphaNumericOptimization, IDictionary<string, string> manifestInfoEntries) : this(tokenizerMaxentModel, manifestInfoEntries, new TokenizerFactory(language, abbreviations, useAlphaNumericOptimization, null))
	  {
	  }
	  ...
	  ///             <seealso cref="TokenizerModel#TokenizerModel(String, AbstractModel, Map, TokenizerFactory)"/>
	  ///             instead and pass in a <seealso cref="TokenizerFactory"/>. 
	  public TokenizerModel(string language, AbstractModel tokenizerMaxentModel, bool useAlphaNumericOptimization, IDictionary<string, string> manifestInfoEntries) : this(language, tokenizerMaxentModel, null, useAlphaNumericOptimization, manifestInfoEntries)
	  {
	  }
	  ...
	  ///             <seealso cref="TokenizerModel#TokenizerModel(String, AbstractModel, Map, TokenizerFactory)"/>
	  ///             instead and pass in a <seealso cref="TokenizerFactory"/>. 
	  public TokenizerModel(string language, AbstractModel tokenizerMaxentModel, bool useAlphaNumericOptimization) : this(language, tokenizerMaxentModel, useAlphaNumericOptimization, null)
	  {
	  }
...
//ORIGINAL LINE: @Override protected void validateArtifactMap() throws opennlp.tools.util.InvalidFormatException
	  ...
	  public AbstractModel MaxentModel
	  {
		  get
		  {
			return (AbstractModel) artifactMap[TOKENIZER_MODEL_ENTRY];
		  }
	  }
