...
namespace opennlp.tools.tokenize
{
    ...
    public class TokenizerFactory : BaseToolFactory
    {
        ...
        public TokenizerFactory(string languageCode, Dictionary abbreviationDictionary, bool useAlphaNumericOptimization,
            Pattern alphaNumericPattern)
        {
            this.init(languageCode, abbreviationDictionary, useAlphaNumericOptimization, alphaNumericPattern);
        }

        protected internal virtual void init(string languageCode, Dictionary abbreviationDictionary,
            bool useAlphaNumericOptimization, Pattern alphaNumericPattern)
        {
        ...
        public virtual bool UseAlphaNumericOptmization
        {
            get
            {
                ...
                {
                    this.useAlphaNumericOptimization =
                        Convert.ToBoolean(artifactProvider.getManifestProperty(USE_ALPHA_NUMERIC_OPTIMIZATION));
                }
